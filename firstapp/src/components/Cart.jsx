...
export default function Cart() {
    ...
    async function fetchCart() {
        ...
        axios.get("http://localhost:4000/api/cart", { params: { userId } })
            .then(res => {
                if (res.status === 200) {
                    setCart(res.data)
                    setLoading(false)
    ...
    async function deleteItem(productId) {
        axios.delete(`http://localhost:4000/api/cart/remove/${productId}`, {
            params: { userId }
        })
            .then(res => {
                if (res.status === 200) {
    ...
    async function checkout() {
        axios.post("http://localhost:4000/api/cart/checkout", {}, { params: { userId } })
            .then(res => {
                if (res.status === 200) {
